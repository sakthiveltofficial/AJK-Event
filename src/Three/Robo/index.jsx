  ...
  return (
    ...
    >
      <group name="Scene">
        ...
        <group
          name="Cube014_10"
          position={[-6.472, 0, -7.522]}
          rotation={[-Math.PI / 2, 0, -2.931]}
        >
          <mesh
            name="Object_11"
            castShadow
        ...
        <group
          name="Cylinder008_2"
          position={[4.954, 0, -3.847]}
          rotation={[-Math.PI / 2, 0, 2.226]}
        >
          <mesh
            name="Object_28"
            castShadow
...
useGLTF.preload("/models/Robo/robo.glb");
